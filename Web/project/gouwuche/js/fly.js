!function(a) {
	a.fly=function(b,c) {
	var d= {
	version:"1.0.0",autoPlay:!0,vertex_Rtop:20,speed:1.2,start: {
}
,end: {
}
,onEnd:a.noop}
...
,d,b);
	...
	f.css( {
	marginTop:"0px",marginLeft:"0px",position:"fixed"}
	...
	a.extend(!0,c, {
	count:-1,steps:j,vertex_left:l,vertex_top:h,curvature:m}
)}
,e.play=function() {
	this.move()}
,e.move=function() {
	...
	f.css( {
	width:k+"px",height:l+"px","font-size":Math.min(k,l)+"px"}
)}
f.css( {
	left:h+"px",top:i+"px"}
),b.count++;
